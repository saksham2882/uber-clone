...
const Home = () => {
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      <img className='w-16 absolute left-5 top-5' src="https://freelogopng.com/images/all_img/1659761297uber-icon.png" alt="" />
      ...
      <div className='flex flex-col justify-end h-screen absolute top-0 w-full'>
        ...
        <div className='h-[30%] p-6 bg-white relative'>
          <h5
            ...
            className='absolute opacity-0 top-6 right-6 text-2xl bg-gray-100 px-1 rounded-full cursor-pointer'>
          ...
          <form onSubmit={(e) => { submitHandler(e) }}>
            <div className={`line absolute h-16 w-1 top-[45%] left-10 rounded-full ${panelOpen ? 'bg-gray-400' : 'bg-gray-600'}`}></div>
            <input
